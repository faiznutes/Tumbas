...
__decorate([
    (0, class_validator_1.IsEnum)(['DELETE', 'MARK_SOLD', 'CHANGE_STATUS']),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, class_validator_1.IsEnum)(client_1.ProductStatus),
    __metadata("design:type", String)
], BulkActionDto.prototype, "status", void 0);
let ProductsController = class ProductsController {
    productsService;
    constructor(productsService) {
        this.productsService = productsService;
    }
    async findAll(page, limit, category, status, minPrice, maxPrice, sort, search) {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ProductsController.prototype, "bulkAction", null);
